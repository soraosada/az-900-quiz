...
- **問題数: 99問** — 公式 Skills measured（**2026-07-20版**）に対応させて配分
- 出題形式: 単一選択96・複数選択3・うち**正誤判定（はい/いいえ）8問**・文章完成形式も収録（本試験の形式に対応）
- 暗記カード: 31サービス（8カテゴリ）
...
|---|---|---|---|---|
| クラウドの概念 | 25–30% | 28 | 27問 | 27% |
| Azureのアーキテクチャとサービス | 35–40% | 37 | 37問 | 37% |
| Azureの管理とガバナンス | 30–35% | 35 | 35問 | 35% |
