...
- **問題数: 277問** — 公式 Skills measured（**2026-07-20版**）に対応させて配分
- 暗記カード: 65サービス（8カテゴリ）
...
| 分野 | 公式比率 | 収録 | 実比率 |
|---|---|---|---|
| クラウドの概念 | 25–30% | 74問 | 26.7% |
| Azureのアーキテクチャとサービス | 35–40% | 106問 | 38.3% |
| Azureの管理とガバナンス | 30–35% | 97問 | 35.0% |
