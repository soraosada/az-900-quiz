...
- **問題数: 48問** — 出題比率どおりに配分（下記）。模擬試験は48問フルで成立
- 暗記カード: 31サービス（8カテゴリ）
- ※ 本試験を網羅する量（100問超）に向けて随時追加していく前提。追加は `QUESTIONS` 配列に同形式で足すだけ。

## 出題範囲と配点比率（AZ-900 公式スキル）

| 分野 | 比率 | 本アプリの重み | 収録 |
|---|---|---|---|
| クラウドの概念 | 25–30% | 28 | 13問 |
| Azureのアーキテクチャとサービス | 35–40% | 37 | 18問 |
| Azureの管理とガバナンス | 30–35% | 35 | 17問 |
